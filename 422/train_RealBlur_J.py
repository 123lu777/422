...
parser.add_argument('--train_meta', default='./dataset/RealBlur/RealBlur_J_train_list.txt', type=str, help='Directory of train images')
parser.add_argument('--val_dir', default='./dataset/RealBlur', type=str, help='Directory of validation images')
parser.add_argument('--val_meta', default='./dataset/RealBlur/RealBlur_J_test_list.txt', type=str, help='Directory of validation images')
...
parser.add_argument('--session', default='MISCFilter_RealBlur_J', type=str, help='session')
