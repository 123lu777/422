...
parser.add_argument('--train_dir', default='./dataset/RealBlur', type=str, help='Directory of train images')
parser.add_argument('--train_meta', default='./dataset/RealBlur/RealBlur_R_train_list.txt', type=str, help='Directory of train images')
parser.add_argument('--val_dir', default='./dataset/RealBlur', type=str, help='Directory of validation images')
parser.add_argument('--val_meta', default='./dataset/RealBlur/RealBlur_R_test_list.txt', type=str, help='Directory of validation images')
...
parser.add_argument('--session', default='MISCFilter_RealBlur_R', type=str, help='session')
...
for epoch in range(start_epoch, num_epochs + 1):
    ...
    for i, data in enumerate(train_loader, 0):
        ...
        restored, loss_kernel = model_restoration(input_)
